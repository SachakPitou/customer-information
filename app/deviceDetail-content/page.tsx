    ...
    useEffect(() => {
        ...
        const filteredDevices = devices.filter((device) => {
            ...
            if (searchField === 'all') {
                ...
                isMatchingSearch = parseInt(modelString) === parseInt(searchTerm);
            } else if (searchField === 'device_type') {
                const deviceTypeString = device.device_type?.toString() || '';
                isMatchingSearch = parseInt(deviceTypeString) === parseInt(searchTerm);
            } else if (searchField === 'port') {
                const ipAddressString = device.port?.toString() || '';
                isMatchingSearch = parseInt(ipAddressString) === parseInt(searchTerm);
            }
            
            return isMatchingSearch; // Return true if both search and status match
        });
            ...
            <div className="flex w-full items-center justify-between p-4 bg-white dark:bg-gray-900">
                ...
                {/* <div className='mr-5'>
                    ...
                    >
                        ...
                        <option value="device_tyoe">Device Type</option>
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    {filteredDevices.map((device) => (
                        <tr key={device.device_id} className="dashboard-text bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
